...
<?php $component->withAttributes([]); ?>
        <!-- BEGIN: Login Info -->
         <?php $__env->slot('LoginInfo', null, []); ?> 
            <img src="<?php echo e(asset('dist/images/1558260216873.jfif')); ?>" alt="123">
         <?php $__env->endSlot(); ?>
        <!-- END: Login Info -->
                    ...
                    <form method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="intro-x mt-8 ">
                            <label for="email"></label><input type="email"
                                ...
                                name="email" :value="<?php echo old('email'); ?>" id="email" placeholder="ایمیل"
                                autofocus>
...
<?php endif; ?>
<?php /**PATH C:\Users\Ali\Documents\GitHub\snappfood\snappfood\resources\views/auth/login.blade.php ENDPATH**/ ?>