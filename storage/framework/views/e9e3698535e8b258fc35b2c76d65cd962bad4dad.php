...
<div x-data="{
    ...
    x-on:keydown.shift.tab.prevent="prevFocusable().focus()" x-show="show" id="<?php echo e($id); ?>"
    class="jetstream-modal fixed inset-0 overflow-y-auto px-4 py-6 sm:px-0 z-50 flex items-center" style="display: none;">
...
<?php /**PATH C:\Users\Ali\Documents\GitHub\snappfood\snappfood\resources\views/vendor/jetstream/components/modal.blade.php ENDPATH**/ ?>