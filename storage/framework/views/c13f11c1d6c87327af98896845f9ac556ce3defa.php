...
} elseif ($_instance->childHasBeenRendered('l2633802323-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2633802323-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2633802323-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2633802323-0');
} else {
    $response = \Livewire\Livewire::mount('delete-modal', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2633802323-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('l2633802323-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l2633802323-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2633802323-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2633802323-1');
} else {
    $response = \Livewire\Livewire::mount('admin.modals.banner-modal', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2633802323-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <!-- BEGIN: Content -->
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'jetstream::components.button','data' => ['class' => 'btn btn-elevated-danger w-16 ml-1 mb-2 text-indigo-900','wire:click' => '$emit(\'DeleteModals\',\'\\\App\\\Models\\\Banner\','.e($pic->id).',\'حذف بنر\' ,\'آیا از حذف بنر '.e($pic->name).' مطمئن هستید ؟\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH C:\Users\Ali\Documents\GitHub\snappfood\snapp_food\resources\views/livewire/admin/banner.blade.php ENDPATH**/ ?>