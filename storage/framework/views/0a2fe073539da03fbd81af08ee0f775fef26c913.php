...
} elseif ($_instance->childHasBeenRendered('l2446862786-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2446862786-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2446862786-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2446862786-0');
} else {
    $response = \Livewire\Livewire::mount('delete-modal', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2446862786-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('l2446862786-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l2446862786-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2446862786-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2446862786-1');
} else {
    $response = \Livewire\Livewire::mount('admin.modals.discount-edit-modal', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2446862786-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('l2446862786-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l2446862786-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2446862786-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2446862786-2');
} else {
    $response = \Livewire\Livewire::mount('admin.modals.food-discount-add-modal', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2446862786-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <!-- BEGIN: Content -->
...
<?php /**PATH C:\Users\Ali\Documents\GitHub\snappfood\snappfood\resources\views/livewire/admin/discount-panel.blade.php ENDPATH**/ ?>