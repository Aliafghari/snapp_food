                    ...
                    <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-12 lg:col-span-12 mt-8">
                            ...
                            <div class="intro-y box p-5 mt-12 sm:mt-5">
                                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.charts.comment', [])->html();
} elseif ($_instance->childHasBeenRendered('l1547579385-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1547579385-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1547579385-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1547579385-0');
} else {
    $response = \Livewire\Livewire::mount('admin.charts.comment', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1547579385-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\Ali\snappfood-master\resources\views/livewire/admin/admin-dashboard.blade.php ENDPATH**/ ?>