...
} elseif ($_instance->childHasBeenRendered('l3218093128-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3218093128-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3218093128-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3218093128-0');
} else {
    $response = \Livewire\Livewire::mount('delete-modal', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3218093128-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('l3218093128-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3218093128-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3218093128-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3218093128-1');
} else {
    $response = \Livewire\Livewire::mount('admin.modals.discount-edit-modal', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3218093128-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('l3218093128-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l3218093128-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3218093128-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3218093128-2');
} else {
    $response = \Livewire\Livewire::mount('admin.modals.food-discount-add-modal', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3218093128-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <!-- BEGIN: Content -->
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.button','data' => ['class' => 'btn btn-elevated-secondary w-24 ml-1 mb-2 text-indigo-900','wire:click' => '$emit(\'DeleteModals\',\'App\\\Models\\\Discount\','.e($Discount->id).',\'حذف کد تخفیف\' ,\'آیا از حذف کد تخفیف '.e($Discount->title).' مطمئن هستید ؟\')']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH C:\xampp\htdocs\Ali\snappfood-master\resources\views/livewire/admin/discount-panel.blade.php ENDPATH**/ ?>