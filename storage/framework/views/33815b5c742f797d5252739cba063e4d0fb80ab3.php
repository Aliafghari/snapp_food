...
} elseif ($_instance->childHasBeenRendered('l243342307-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l243342307-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l243342307-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l243342307-0');
} else {
    $response = \Livewire\Livewire::mount('delete-modal', []);
    $html = $response->html();
    $_instance->logRenderedChild('l243342307-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('l243342307-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l243342307-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l243342307-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l243342307-1');
} else {
    $response = \Livewire\Livewire::mount('seller.modals.order-details-modal', []);
    $html = $response->html();
    $_instance->logRenderedChild('l243342307-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <!-- BEGIN: Content -->
...
<?php /**PATH C:\Users\Ali\Documents\GitHub\snappfood\snappfood\resources\views/livewire/seller/archive-order.blade.php ENDPATH**/ ?>