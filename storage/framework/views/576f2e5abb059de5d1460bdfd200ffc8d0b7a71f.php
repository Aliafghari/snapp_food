<div class="hidden xl:flex flex-col min-h-screen">
    <a href="" class="-intro-x flex items-center pt-5">
        ...
        <span class="text-white text-lg mr-3 adjust "> ایس<span class="font-medium">وال</span> </span>
    </a>
    <div class="my-auto">
...
<?php /**PATH C:\xampp\htdocs\Ali\snappfood-master\resources\views/vendor/jetstream/components/authentication-card-logo.blade.php ENDPATH**/ ?>