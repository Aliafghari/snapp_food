...
<div id="<?php echo e($mapId); ?>" <?php if(isset($attributes['class'])): ?> class='<?php echo e($attributes['class']); ?>' <?php endif; ?>></div>
...
<script>
    var mymap = L.map('<?php echo e($mapId); ?>').setView([<?php echo e($centerPoint['lat'] ?? $centerPoint[0]); ?>,
        <?php echo e($centerPoint['long'] ?? $centerPoint[1]); ?>

    ], <?php echo e($zoomLevel); ?>);
    ...
    <?php if($tileHost === 'mapbox'): ?>
        let url<?php echo e($mapId); ?> =
            'https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=<?php echo e(config('maps.mapbox.access_token', null)); ?>';
...
<?php /**PATH C:\Users\Ali\Documents\GitHub\snappfood\snappfood\resources\views/vendor/maps/components/leaflet.blade.php ENDPATH**/ ?>