...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> 
        <?php echo e(__('احراز هویت دو عاملی')); ?>

     <?php $__env->endSlot(); ?>

     <?php $__env->slot('description', null, []); ?> 
        <?php echo e(__('با استفاده از احراز هویت دو مرحله ای، امنیت بیشتری را به حساب خود اضافه کنید.')); ?>
     ...
     <?php $__env->slot('content', null, []); ?> 
        <h3 class="text-lg font-medium text-gray-900">
            <?php if($this->enabled): ?>
                <?php if($showingConfirmation): ?>
                    <?php echo e(__('فعال کردن احراز هویت دو مرحله‌ای را تمام کنید.')); ?>

                <?php else: ?>
                    <?php echo e(__('شما احراز هویت دو مرحله ای را فعال کرده اید.')); ?>

                <?php endif; ?>
            <?php else: ?>
                <?php echo e(__('شما احراز هویت دو مرحله ای را فعال نکرده اید.')); ?>
        ...
        <div class="mt-3 max-w-xl text-sm text-gray-600">
            <p>
                <?php echo e(__('وقتی احراز هویت دو مرحله‌ای فعال باشد، در حین احراز هویت از شما خواسته می‌شود که یک نشانه امن و تصادفی را دریافت کنید. می توانید این نشانه را از برنامه Google Authenticator گوشی خود بازیابی کنید.')); ?>
            ...
            <?php if($showingQrCode): ?>
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                        <?php if($showingConfirmation): ?>
                            <?php echo e(__('برای پایان دادن به فعال کردن احراز هویت دو مرحله‌ای، کد QR زیر را با استفاده از برنامه احراز هویت گوشی خود اسکن کنید یا کلید تنظیم را وارد کرده و کد OTP تولید شده را ارائه دهید.')); ?>

                        <?php else: ?>
                            <?php echo e(__('احراز هویت دو مرحله ای اکنون فعال است. کد QR زیر را با استفاده از برنامه احراز هویت گوشی خود اسکن کنید یا کلید تنظیم را وارد کنید.')); ?>
                ...
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                        <?php echo e(__('کلید راه اندازی')); ?>: <?php echo e(decrypt($this->user->two_factor_secret)); ?>
                ...
                <?php if($showingConfirmation): ?>
                    <div class="mt-4">
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'jetstream::components.label','data' => ['for' => 'code','value' => ''.e(__('کد')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'code','value' => ''.e(__('کد')).'']); ?>
...
<?php endif; ?>
                        ...
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'jetstream::components.input','data' => ['id' => 'code','type' => 'text','name' => 'code','class' => 'block mt-1 w-1/2','inputmode' => 'numeric','autofocus' => true,'autocomplete' => 'one-time-code','wire:model.defer' => 'code','wire:keydown.enter' => 'confirmTwoFactorAuthentication']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                        ...
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'jetstream::components.input-error','data' => ['for' => 'code','class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            ...
            <?php if($showingRecoveryCodes): ?>
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                        <?php echo e(__('این کدهای بازیابی را در یک مدیر رمز عبور امن ذخیره کنید. اگر دستگاه احراز هویت دو مرحله ای شما گم شود، می توان از آنها برای بازیابی دسترسی به حساب شما استفاده کرد.')); ?>
...
<?php $component->withAttributes(['class' => 'mr-3']); ?>
                            <?php echo e(__('بازیابی کدهای بازیابی')); ?>
...
<?php $component->withAttributes(['wire:then' => 'confirmTwoFactorAuthentication']); ?>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'jetstream::components.button','data' => ['type' => 'button','class' => 'mr-3','wire:loading.attr' => 'disabled']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('jet-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mr-3']); ?>
                            <?php echo e(__('نمایش کدهای بازیابی')); ?>
...
<?php $component->withAttributes(['wire:then' => 'disableTwoFactorAuthentication']); ?>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'jetstream::components.secondary-button','data' => ['wire:loading.attr' => 'disabled']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('jet-secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH C:\Users\Ali\Documents\GitHub\snappfood\snapp_food\resources\views/profile/two-factor-authentication-form.blade.php ENDPATH**/ ?>