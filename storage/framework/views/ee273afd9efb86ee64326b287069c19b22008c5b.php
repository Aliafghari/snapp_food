                ...
                <div class="col-span-12 xxl:col-span-9">
                    <div class="grid grid-cols-12 gap-6">
                                ...
                                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            ...
                                            <div class="text-3xl font-bold leading-8 mt-6"><?php echo e($SellCount); ?></div>
                                ...
                                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            ...
                                            <div class="text-3xl font-bold leading-8 mt-6"><?php echo e($sumSellPrice); ?></div>
                                ...
                                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            ...
                                            <div
                                                class="text-3xl font-bold leading-8 mt-6"><?php echo e($SellCompleteStatus); ?></div>
                                ...
                                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            ...
                                            <div
                                                class="text-3xl font-bold leading-8 mt-6"><?php echo e($sellSusspendStatus); ?></div>
                        ...
                        <div class="col-span-12 xl:col-span-4 mt-6">
                            ...
                            <div class="mt-5">
                                <?php if($BestSeller->first() != 'null'): ?>
                                    <?php $__currentLoopData = $BestSeller; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="intro-y">
                                            <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                                ...
                                                <div class="mr-4 ml-auto">
                                                    <div
                                                        class="font-medium"><?php echo e($seller->first()->RestaurantDetail->name); ?></div>
                                                    <div
                                                        class="text-gray-600 text-xs mt-0.5"><?php echo e($seller->first()->RestaurantDetail->created_at); ?></div>
                                                </div>
                                                <div
                                                    class="py-1 px-2 rounded-full text-xs bg-theme-10 text-white cursor-pointer font-medium">
                                                    <?php echo e($seller->count()); ?> فروش
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="xxl:border-l border-theme-25 -mb-10 pb-10">
                        <div class="xxl:pl-6 grid grid-cols-12 gap-6">
                            ...
                            <div class="col-span-12 md:col-span-6 xl:col-span-4 xxl:col-span-12 mt-3 xxl:mt-8">
                                ...
                                <div class="mt-5">
                                    <?php if($OrdersDetails->first() != null): ?>
                                        <?php $__currentLoopData = $OrdersDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="intro-x">
                                                <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                                    ...
                                                    <div class="mr-4 ml-auto">
                                                        <div class="font-medium"><?php echo e($item->cart->user->name); ?></div>
                                                        <div
                                                            class="text-gray-600 text-xs mt-0.5"><?php echo e(Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $item->created_at)->format('Y-M-d')); ?></div>
                                                    </div>
                                                    <div class="text-emerald-500"><?php echo e($item->Total_price); ?></div>
                                                </div>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php echo e($OrdersDetails->links()); ?>
                            ...
                            <div class="col-span-12 md:col-span-6 xl:col-span-4 xxl:col-span-12 mt-3 xxl:mt-8">
                                ...
                                <div class="mt-5">
                                    <?php if($OrderSend->first() != null): ?>
                                        <?php $__currentLoopData = $OrderSend; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="intro-x">
                                                <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                                    <div
                                                        class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
...
<?php /**PATH C:\xampp\htdocs\Ali\snappfood-master\resources\views/livewire/seller/dashboard.blade.php ENDPATH**/ ?>