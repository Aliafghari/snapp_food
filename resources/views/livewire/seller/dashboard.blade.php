                        ...
                        <div class="col-span-12 mt-8">
                            <div class="grid grid-cols-12 gap-6 mt-5">
                                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                    ...
                                    <div class="box p-5">
                                        <div class="text-base text-green-600 mt-1 text-center">{{ $SellCount }}</div>
                                ...
                                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                    ...
                                    <div class="box p-5">
                                        <div class="text-base text-red-600 mt-1 text-center">{{ $sumSellPrice }}</div>
                                ...
                                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                    ...
                                    <div class="box p-5">
                                        <div class="text-base text-blue-600 mt-1 text-center">{{ $SellCompleteStatus }}
                                        </div>
                                ...
                                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                    ...
                                    <div class="box p-5">
                                        <div class="text-base text-dark-600 mt-1 text-center">{{ $sellSusspendStatus }}
                                        </div>
                                                ...
                                                <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                                    ...
                                                    <div class="mr-4 ml-auto">
                                                        ...
                                                        <div class="text-gray-600 text-xs mt-0.5">
                                                            {{ Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $item->created_at)->format('Y-M-d') }}
                                                        </div>
                                                    </div>
