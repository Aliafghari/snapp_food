                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($AllComments as $AllComment)
                                            ...
                                            <td class="border-b dark:border-dark-5 text-lg font-medium">
                                                {{ ++$Row }}</td>
                                            <td
                                                class="border-b dark:border-dark-5 text-lg font-medium justify-center flex flex-col">
                                                <p>
                                            ...
                                            <td class="border-b dark:border-dark-5 text-lg font-medium">
                                                {{ $AllComment->user->email }}</td>
                                            <td class="border-b dark:border-dark-5 text-lg font-medium">
                                                {{ $AllComment->orders_id }}</td>
                                            ...
                                            <td class="border-b dark:border-dark-5 text-lg font-medium">
                                                {{ $AllComment->opinion }}</td>
                                            <td class="border-b dark:border-dark-5 text-lg font-medium">
                                                {{ $AllComment->score }}</td>
                                            <td class="border-b dark:border-dark-5 text-lg font-medium">
                                                <x-jet-button
                                                    class="btn btn-elevated-danger w-20 ml-1 mb-2 px-2 h-8 text-indigo-900"
                                                    wire:click="$emit('DeleteModals','\\\App\\\Models\\\Comment',{{ $AllComment->id }},'حذف نظر' ,'آیا از حذف نظر {{ $AllComment->user->name }} مطمئن هستید ؟')">
                                                    حذف
                                                </x-jet-button>
                                            </td>
                                            </tr>
