...
<div class="py-1 px-2 rounded-xl text-xs bg-cyan-400 text-white cursor-pointer font-medium">
    <div class="col-span-12 mt-8">

        <h2
            class="text-lg font-medium truncate ml-5 mt-8 flex-1 w-full btn btn-outline-danger rounded-full mx-auto relative text-right bg-white">
            {{-- <h2 class="py-1 px-2 rounded-full text-2xl bg-red-500 text-dark cursor-pointer font-medium"> --}}
            <b>تبلیغات</b>
...
<div class="py-1 px-2 rounded-xl text-xs bg-cyan-400 text-white cursor-pointer font-medium">
    <h2
        class="text-lg font-medium truncate ml-5 mt-8 flex-1 w-full btn btn-outline-warning rounded-full mx-auto relative text-right bg-white">
        {{-- <h2 class="py-1 px-2 rounded-full text-2xl bg-red-500 text-dark cursor-pointer font-medium"> --}}
        <b>شعبه ها</b>
    </h2>
...
<div class="py-1 px-2 rounded-xl text-xs bg-cyan-400 text-white cursor-pointer font-medium">
    <h2
        class="text-lg font-medium truncate ml-5 mt-8 flex-1 w-full btn btn-outline-success rounded-full mx-auto relative text-right bg-white">
        <b>فودپارتی</b>
    </h2>
